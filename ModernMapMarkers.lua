...
local points = {
	...
	{1, 7, 0.324, 0.44, "Schiff nach Sturmwind", "boat", "Alliance", nil}, -- alliance
	{1, 7, 0.304, 0.41, "Schiff nach Alah’Thalas", "boat", "Alliance", nil},  -- alliance
	{1, 7, 0.333, 0.399, "Schiff nach Rut’theran", "boat", "Alliance", nil}, -- alliance
	{1, 10, 0.718, 0.566, "Schiff nach Hafen von Menethil", "boat", "Alliance", nil}, -- alliance
	{1, 13, 0.311, 0.395, "Schiff zur Vergessenen Küste", "boat", "Alliance", nil}, -- alliance
	{1, 13, 0.431, 0.428, "Schiff zur Sardor-Insel", "boat", "Alliance", nil}, -- alliance
	{1, 28, 0.552, 0.949, "Schiff nach Auberdine", "boat", "Alliance", nil}, -- alliance
    -- Eastern Kingdoms Dungeons
    {2, 26, 0.371, 0.857, "Schwarzfelstiefen", "dungeon", "52-60", 1},
	{2, 8, 0.328, 0.362, "Schwarzfelstiefen", "dungeon", "52-60", 1},
    {2, 38, 0.423, 0.726, "Die Todesminen", "dungeon", "17-24", 3},
    {2, 15, 0.30, 0.27, "Stadt von Gilneas", "dungeon", "43", 5},
    {2, 10, 0.248, 0.337, "Gnomeregan", "dungeon", "29-38", 6},
    {2, 8, 0.95, 0.53, "Hassschmiede Steinbruch", "dungeon", "52-60", 7},
    {2, 9, 0.45, 0.75, "Karazhan Krypta", "dungeon", "58-60", 8},
    {2, 8, 0.321, 0.386, "Untere Schwarzfelsspitze", "dungeon", "55-60", 9},
	{2, 26, 0.364, 0.879, "Untere Schwarzfelsspitze", "dungeon", "55-60", 9},
    {2, 34, 0.869, 0.323, "Scharlachrotes Kloster – Waffenkammer", "dungeon", "32-42", 13}, 
    {2, 34, 0.862, 0.295, "Scharlachrotes Kloster – Kathedrale", "dungeon", "35-45", 14}, 
    {2, 34, 0.839, 0.283, "Scharlachrotes Kloster – Friedhof", "dungeon", "26-36", 15},
    {2, 34, 0.850, 0.338, "Scharlachrotes Kloster – Bibliothek", "dungeon", "29-39", 16},
    {2, 37, 0.69, 0.74, "Scholomance", "dungeon", "58-60", 17},
    {2, 27, 0.44, 0.67, "Burg Schattenfang", "dungeon", "22-30", 18},
    {2, 28, 0.51, 0.675, "Das Verlies", "dungeon", "24-31", 19},
    {2, 28, 0.63, 0.58, "Tresor von Sturmwind", "dungeon", "60", 20},
    {2, 13, 0.29, 0.61, "Tresor von Sturmwind - Horde Eingang", "dungeon", "60", 20},
    {2, 12, 0.31, 0.14, "Stratholme", "dungeon", "58-60", 22},
    {2, 12, 0.47, 0.24, "Stratholme – Hintereingang", "dungeon", "58-60", 22},
    {2, 30, 0.701, 0.55, "Der Versunkene Tempel", "dungeon", "50-60", 23},
    {2, 4, 0.429, 0.130, "Uldaman – Haupteingang", "dungeon", "41-51", 25},
    {2, 4, 0.657, 0.438, "Uldaman – Hintereingang", "dungeon", "41-51", 25},
    {2, 8, 0.312, 0.365, "Upper Blackrock Spire", "dungeon", "55-60", 26},
	{2, 26, 0.355, 0.855, "Obere Schwarzfelsspitze", "dungeon", "55-60", 26},
	...
	{2, 26, 0.332, 0.851, "Pechschwingenhort", "raid", "60", 2},
	{2, 8, 0.273, 0.363, "Pechschwingenhort", "raid", "60", 2},
	{2, 9, 0.46, 0.70, "Untere Hallen von Karazhan", "raid", "58-60", 10},
	{2, 26, 0.336, 0.879, "Geschmolzener Kern", "raid", "60", 11},
	{2, 8, 0.273, 0.387, "Geschmolzener Kern", "raid", "60", 11},
	{2, 12, 0.40, 0.28, "Naxxramas", "raid", "60", 12},
	{2, 9, 0.442, 0.719, "Turm von Karazhan", "raid", "60", 24},
	{2, 29, 0.53, 0.172, "Zul'Gurub", "raid", "60", 27},
	-- Eastern Kingdoms World Bosses
	{2, 9, 0.471, 0.751, "Dunkler Plünderer von Karazhan", "worldboss", "60", nil},
	...
	{2, 12, 0.082, 0.38, "Nerubischer Aufseher", "worldboss", "60", nil},
	-- Eastern Kingdoms Transport
	{2, 28, 0.694, 0.294, "Tiefenbahn nach Eisenschmiede", "tram", "Alliance", nil},  -- alliance
	{2, 19, 0.762, 0.511, "Tiefenbahn nach Sturmwind", "tram", "Alliance", nil},  -- alliance
	{2, 33, 0.812, 0.794, "Schiff nach Funkenwasser Hafen", "boat", "Horde", nil}, -- horde
	{2, 39, 0.068, 0.613, "Schiff nach Theramore", "boat", "Alliance", nil},  -- alliance
	{2, 28, 0.218, 0.563, "Schiff nach Auberdine", "boat", "Alliance", nil}, -- alliance
	{2, 29, 0.257, 0.73, "Schiff nach Ratschet", "boat", "Neutral", nil}, -- neutral
	{2, 34, 0.616, 0.571, "Zeppeline nach Orgrimmar & Grom’gol", "zepp", "Horde", nil}, -- horde
	{2, 29, 0.312, 0.298, "Zeppeline nach Unterstadt & Orgrimmar", "zepp", "Horde", nil}, -- Horde
	{2, 4, 0.075, 0.480, "Zeppelin nach Orgrimmar", "zepp", "Horde",  nil}, -- Horde
	{2, 1, 0.531, 0.047, "Schiff nach Auberdine", "boat", "Alliance", nil}, -- alliance
}
